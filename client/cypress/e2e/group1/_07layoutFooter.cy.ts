...
describe(`[AW IS CLOSED] LayoutFooter:`, () => {
  before(() => {
  ...
  it('Docs link is visible, has correct text and attributes', () => {
    ...
    cy.get('[data-test=LayoutFooter__link--docs]').invoke('attr', 'target').should('eq', '_blank');
  });
  ...
  it('Blog link is visible, has correct text and attributes', () => {
    ...
    cy.get('[data-test=LayoutFooter__link--blog]').invoke('attr', 'target').should('eq', '_blank');
  });
  ...
  it('Brand assets link is visible, has correct text and attributes', () => {
    ...
    cy.get('[data-test=LayoutFooter__link--brandAssets]')
      .invoke('attr', 'href')
      .should('eq', 'https://www.figma.com/community/file/1295533951881708349/octant-brand-assets');
    cy.get('[data-test=LayoutFooter__link--brandAssets]')
      .invoke('attr', 'target')
      .should('eq', '_blank');
  });
