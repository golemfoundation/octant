...
const mutateAsyncMoveToDecisionWindowClosed = (cypressWindow: Cypress.AUTWindow) => new Cypress.Promise(resolve => {
...
const moveToDecisionWindowOpen = (cypressWindow: Cypress.AUTWindow) => {
