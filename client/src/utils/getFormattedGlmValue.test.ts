...
const testCases = [
  ...
  { argument: BigNumber.from(10).pow(14).sub(1), expectedValue: '0.0001 GLM' },
  { argument: BigNumber.from(10).pow(14), expectedValue: '0.0001 GLM' },
  { argument: BigNumber.from(10).pow(15).sub(1), expectedValue: '0.001 GLM' },
  { argument: BigNumber.from(10).pow(15), expectedValue: '0.001 GLM' },
  { argument: BigNumber.from(10).pow(16).sub(1), expectedValue: '0.01 GLM' },
  { argument: BigNumber.from(10).pow(16), expectedValue: '0.01 GLM' },
  { argument: BigNumber.from(10).pow(17).sub(1), expectedValue: '0.1 GLM' },
  { argument: BigNumber.from(10).pow(17), expectedValue: '0.1 GLM' },
  ...
  { argument: BigNumber.from(10).pow(22).sub(1), expectedValue: '10000 GLM' },
  { argument: BigNumber.from(10).pow(22), expectedValue: '10000 GLM' },
];
