...
import MetricsGridTotalGlmLockedAndTotalSupplyProps from './types';
import { roundLockedRatio } from './utils';

const MetricsGridTotalGlmLockedAndTotalSupply: FC<MetricsGridTotalGlmLockedAndTotalSupplyProps> = ({
  isLoading = false,
}) => {
...
export default MetricsGridTotalGlmLockedAndTotalSupply;
