...
import MetricsGridLargestGlmLockProps from './types';

const MetricsGridLargestGlmLock: FC<MetricsGridLargestGlmLockProps> = ({ isLoading = false }) => {
...
export default MetricsGridLargestGlmLock;
