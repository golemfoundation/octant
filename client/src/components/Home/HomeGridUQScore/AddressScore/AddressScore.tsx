...
import styles from './AddressScore.module.scss';
import AddressScoreProps from './types';

const AddressScore: FC<AddressScoreProps> = ({
  address,
  badge,
  score,
  className,
  ...
  const { t } = useTranslation('translation', {
    keyPrefix: 'components.home.homeGridUQScore.addressScore',
  });
...
export default memo(AddressScore);
