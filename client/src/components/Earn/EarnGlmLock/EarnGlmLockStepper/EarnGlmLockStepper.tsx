...
import EarnGlmLockStepperProps from './types';

const EarnGlmLockStepper: FC<EarnGlmLockStepperProps> = ({ currentMode, step, className }) => {
...
export default EarnGlmLockStepper;
