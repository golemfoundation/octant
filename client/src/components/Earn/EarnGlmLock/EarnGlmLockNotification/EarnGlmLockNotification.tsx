...
import styles from './EarnGlmLockNotification.module.scss';
import EarnGlmLockNotificationProps from './types';
...
const EarnGlmLockNotification: FC<EarnGlmLockNotificationProps> = ({
  className,
  isLockingApproved,
  type,
  transactionHash,
...
export default EarnGlmLockNotification;
