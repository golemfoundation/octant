...
import styles from './ProposalDonorsListItem.module.scss';
import ProposalDonorsListItemProps from './types';

const ProposalDonorsListItem: FC<ProposalDonorsListItemProps> = ({
  donorAddress,
  amount,
  className,
}) => {
...
export default memo(ProposalDonorsListItem);
