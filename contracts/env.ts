...
const GNT_ADDRESS = process.env.GNT_ADDRESS || '0xc13a6e17a12fbeaD2a689751076A216076b7e351';
const GLM_ADDRESS = process.env.GLM_ADDRESS || '0x93fc9b53E73b744e9bB1f98B2D91a83047ecBB1F';
const GLM_FAUCET_ADDRESS =
  process.env.GLM_FAUCET_ADDRESS || '0x7236eA6198F4eF69355DC5CB25F7f09E5439f754';
