...
# Move run_test to the top of the file, after imports
default_port = 8766
...
async def run_test(
    ...
    await wait_for_server("127.0.0.1", default_port, timeout=3.0)
    ...
    try:
        ...
        await sio.connect(f"http://127.0.0.1:{default_port}")
