...
from tests.helpers.constants import MATCHED_REWARDS, LOW_UQ_SCORE, MR_FUNDING_CAP_PERCENT
...
def test_simulate_allocation_with_user_uq_score(service, mock_users_db):
    ...
    assert rewards == [
        ...
        ProjectRewardDTO(
            sorted_projects[2], 200000000000, int(MATCHED_REWARDS * MR_FUNDING_CAP_PERCENT)
        ),
