...
from app.modules.user.events_generator.service.db_and_graph import DbAndGraphEventsGenerator
...
def test_delegation(context, payload, tos_users, patch_is_contract):
    ...
    service = SimpleObfuscationDelegation(verifier=verifier, antisybil=antisybil, user_deposits_service=user_deposits)
...
def test_delegation_disabled_when_secondary_is_locking(context, mock_events_generator, tos_users, patch_is_contract):
    verifier = SimpleObfuscationDelegationVerifier()
