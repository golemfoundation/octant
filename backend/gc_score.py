import time
import json
from app.infrastructure.external_api.gc_passport.score import signing_message, issue_address_for_scoring, fetch_score, fetch_stamps
...
# print(f"{json.dumps(fetch_stamps(pzelazko_eth_addr))}")
