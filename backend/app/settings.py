...
class Config(object):
    ...
    SUBGRAPH_ENDPOINT = os.getenv('SUBGRAPH_ENDPOINT',
                                  'https://octant.world/subgraphs/name/octant')
    ...
    EPOCHS_CONTRACT_ADDRESS = os.getenv('EPOCHS_CONTRACT_ADDRESS',
                                        '0xFf2cc5C9fD16dBFef0020b13CDDB59BA4D89BBBC')
    PROPOSALS_CONTRACT_ADDRESS = os.getenv('PROPOSALS_CONTRACT_ADDRESS',
                                           '0x17c09dA7c6Ba1Dd24AdbEB514CF8f07c9aEfd655')
...
class ProdConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv('DB_URI',
                                        'postgresql://user:password@localhost/octant')
