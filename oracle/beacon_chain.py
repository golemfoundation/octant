...
def get_beacon_epoch_by_block_number(block_number):
...
def get_validators_balances(epoch):
...
def update_oracle(epoch, block_number, nonce):
    beacon_epoch_number = get_beacon_epoch_by_block_number(block_number)
    balance = get_validators_balances(beacon_epoch_number)
