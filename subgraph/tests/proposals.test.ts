...
import { EpochProjectsMetadata } from '../generated/schema';
...
describe('handleSetProposalAddresses', () => {
  beforeEach(() => {
    const epochProjects = new EpochProjectsMetadata(Bytes.fromI32(1));
  ...
  test('Should create a new EpochProjectsMetadata entity', () => {
    ...
    assert.entityCount('EpochProjectsMetadata', 2);
    assert.fieldEquals('EpochProjectsMetadata', Bytes.fromI32(1).toHexString(), 'epoch', '1');
    assert.fieldEquals(
    ...
    assert.fieldEquals('EpochProjectsMetadata', Bytes.fromI32(2).toHexString(), 'epoch', '2');
    assert.fieldEquals(
      'EpochProjectsMetadata',
  ...
  test('Should create and update a new EpochProjectsMetadata entity', () => {
    const setProposalAddressesCall = createSetProposalAddressesCall(2, epoch2Addresses);
    handleSetProposalAddresses(setProposalAddressesCall);
  ...
  test('Should create new EpochProjectsMetadata entity and update CID in it after', () => {
    const setProposalAddressesCall = createSetProposalAddressesCall(2, epoch2Addresses);
    handleSetProposalAddresses(setProposalAddressesCall);
  ...
  test('Should set new CID and create new Epoch EpochProjectsMetadata inherited from previous Epoch', () => {
    assert.entityCount('EpochProjectsMetadata', 1);
    assert.fieldEquals('EpochProjectsMetadata', Bytes.fromI32(1).toHexString(), 'epoch', '1');
    assert.fieldEquals(
      'EpochProjectsMetadata',
      Bytes.fromI32(1).toHexString(),
  ...
  test('Should create a new AccumulatedProjectsMetadata', () => {
    assert.entityCount('AccumulatedProjectsMetadata', 0);

    const setProposalAddressesCall = createSetProposalAddressesCall(1, epoch1Addresses);
    handleSetProposalAddresses(setProposalAddressesCall);

    assert.entityCount('AccumulatedProjectsMetadata', 1);
    assert.fieldEquals(
      'AccumulatedProjectsMetadata',
  ...
  test('Should create and update an AccumulatedProjectsMetadata', () => {
    assert.entityCount('AccumulatedProjectsMetadata', 0);
