...
describe('handleSetProposalAddresses', () => {
  beforeEach(() => {
    const epochProjects = new EpochProjectsInfo(Bytes.fromI32(1));
  ...
  test('Should create a new EpochProjectsInfo entity', () => {
    ...
    assert.fieldEquals('EpochProjectsInfo', Bytes.fromI32(2).toHexString(), 'epoch', '2');
    assert.fieldEquals(
      'EpochProjectsInfo',
  ...
  test('Should create new EpochProjectsInfo entity and update CID in it after', () => {
    const setProposalAddressesCall = createSetProposalAddressesCall(2, epoch2Addresses);
    handleSetProposalAddresses(setProposalAddressesCall);
  ...
  test('Should set new CID and create new Epoch EpochProjectsInfo inherited from previous Epoch', () => {
    assert.entityCount('EpochProjectsInfo', 1);
    assert.fieldEquals('EpochProjectsInfo', Bytes.fromI32(1).toHexString(), 'epoch', '1');
    assert.fieldEquals(
      'EpochProjectsInfo',
      Bytes.fromI32(1).toHexString(),
